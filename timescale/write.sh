...
echo "=== TimescaleDB Insert Performance Benchmark ==="
echo ""
...
for i in {1..10}; do
    ...
    sudo -u postgres psql test -t -c "INSERT INTO transactions (id, user_id, amount, type, country_code, platform, created_at) VALUES (99999999$i, $user_id, 150, 'purchase', 'SE', 'web', '2025-01-01 00:00:0$i');"
