...
echo "=== pg_mooncake Insert Performance Benchmark ==="
echo ""
...
for i in {1..10}; do
    ...
    psql $CONNECTION -t -c "INSERT INTO transactions (id, user_id, amount, type, country_code, platform, created_at) VALUES (99999999$i, $user_id, 150, 'purchase', 'SE', 'web', '2025-01-01 00:00:0$i');"
...
psql $CONNECTION -t -c "DELETE FROM transactions WHERE id >= 999999991;"
