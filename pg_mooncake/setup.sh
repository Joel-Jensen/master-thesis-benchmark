...
for chunk in /tmp/split_10M/transactions_chunk_*
do
...
psql postgres://postgres:pg_mooncake@localhost:5433/postgres -c "\\copy users (id, name, email, email_verified_at, password, country_code, is_active, remember_token, created_at, updated_at) FROM '/tmp/users_10M.csv' DELIMITER ','"
